...
func main(){
  ...
  var e1 string = "    _  _     _  _     _  _ "
  var e2 string = "  | _| _||_||_ |_   ||_||_|"
  var e3 string = "  ||_  _|  | _||_|  ||_| _|"

  analysis(e1, e2, e3)
	
}

func analysis(e1,e2,e3 string){
  ...
  fmt.Println(account)
  if flag==1 { 
    fmt.Printf("==> "+account+" ILL") 
  } else { fmt.Printf("==> "+account+" "+checkSum(account)) }
}

func decoder(c1, c2, c3 string) string {
  var digit=""
